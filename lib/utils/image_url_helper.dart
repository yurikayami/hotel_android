...
class ImageUrlHelper {
  ...
  static String formatImageUrl(String? imageUrl) {
    ...
    if (imageUrl.contains('192.168.1.3')) {
      return imageUrl;
    }

    // If it's just a path like /uploads/...
    if (imageUrl.startsWith('/')) {
      // Extract the port from baseUrl if available
      return 'https://192.168.1.3:7043$imageUrl';
    }

    // Replace localhost with IP
    String url = imageUrl;
    url = url.replaceAll('localhost', '192.168.1.3');
  ...
  static String get imageBaseUrl => 'https://192.168.1.3:7043';
